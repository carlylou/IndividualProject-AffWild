...
def densenet121(inputs, num_classes=1000, data_format='NHWC', is_training=True, reuse=None):
  return densenet(inputs,
                  ...
                  reduction=0.5, # checked
                  growth_rate=32, # checked
                  num_filters=64,
                  num_layers=[6,12,24,16], # checked
                  data_format=data_format,
                  is_training=is_training,
                  reuse=reuse,
                  scope='densenet121')
densenet121.default_image_size = 96
...
def densenet161(inputs, num_classes=1000, data_format='NHWC', is_training=True, reuse=None):
  return densenet(inputs,
                  num_classes=num_classes, 
                  reduction=0.5, # checked
                  growth_rate=48, # checked
                  num_filters=96,
                  num_layers=[6,12,36,24], # checked
                  data_format=data_format,
                  is_training=is_training,
                  reuse=reuse,
                  scope='densenet161')
densenet161.default_image_size = 96
...
def densenet169(inputs, num_classes=1000, data_format='NHWC', is_training=True, reuse=None):
  return densenet(inputs,
                  ...
                  growth_rate=32, # checked
                  num_filters=64,
                  num_layers=[6,12,32,32], # checked
                  data_format=data_format,
                  is_training=is_training,
                  reuse=reuse,
                  scope='densenet169')
densenet169.default_image_size = 96
