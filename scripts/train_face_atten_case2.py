...
'''
train the whole cnn-rnn architecture (for the cnn restore the pretrained)
'''
...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_atten_case2_sq80_hu100/output_train.txt')
...
TRAIN_DIR = '/vol/gpudata/ml9915/check_point/face_atten_case2_sq80_hu100/'
...
def train():
    ...
    with g.as_default():
        ...
        with tf.Session(graph=g) as sess:
            ...
            prediction = models.get_prediction_atten_hu(rnn_in, attn_length=30, hidden_units=100)
