...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face-gru-highway/output_valid.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face-gru-highway/'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face-gru-highway/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
