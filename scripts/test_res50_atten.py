...
''' test path '''
TEST_CKPT_PATH = 'res50_atten_case3'
...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/'+TEST_CKPT_PATH+'/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/'+TEST_CKPT_PATH+'/'
GLOBAL_STEP = 36954
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-' + str(GLOBAL_STEP)
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/'+TEST_CKPT_PATH+'/test/'
