...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/res50_atten_case3/output_train.txt')
...
def get_RNN_variables():
    ...
    cnn_variables = tf.contrib.framework.get_variables_to_restore(include=rnn_names)
    return cnn_variables
    ...
    with g.as_default():
        ...
        with tf.Session(graph=g) as sess:
            ...
            resnet_init_assign_op, resnet_init_feed_dict = slim.assign_from_checkpoint(
                ResNet_RESTORE_PATH, get_CNN_variables(), ignore_missing_vars=False)
