...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/resnet50_ft_atten_whole/output_train.txt')
...
# resnet50_ft_atten : fix CNN and train RNN
# resnet50_ft_atten_lastconv : train last CNN and RNN

TRAIN_DIR = '/vol/gpudata/ml9915/check_point/resnet50_ft_atten_whole/'
TRAIN_TFR_PATH = '/vol/gpudata/ml9915/TFRecords/train/'
VF2_RESTORE_PATH = '/vol/gpudata/ml9915/caffe_model/resnet50_ft_caffe/resnet50_ft.npy'
ResNet50_RESTORE_PATH = '/vol/gpudata/ml9915/caffe_model/resnet50_ft_caffe/model.ckpt-0'
...
def get_restore_variable():
    data_dict = np.load(VF2_RESTORE_PATH).item()
    restores = []
    for op_name in data_dict:
        restores.append(op_name)
        print op_name
    restores.remove('classifier')
    return restores
...
def train():
    ...
    with g.as_default():
        ...
        with tf.Session(graph=g) as sess:
            ...
            resnet = ResNet50({'data':image_batch}, trainable=False, is_training=True)
            ...
            # MODEL_PATH = '/vol/gpudata/ml9915/caffe_model/resnet50_ft_caffe/model.ckpt'
            ...
            init_fn = slim.assign_from_checkpoint_fn(ResNet50_RESTORE_PATH, tf.global_variables(), ignore_missing_vars=True)
            # init_fn(sess)
            ...
            # trainable_names = ['bn', 'conv5', 'attention-layer', 'fcatten']
