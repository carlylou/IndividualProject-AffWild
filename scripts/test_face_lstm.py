...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face-lstm-128/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face-lstm-128/'
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-49898'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face-lstm-128/test/'
# HYPER-PARAMETERS
FRAMES_VALID = 135145
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
