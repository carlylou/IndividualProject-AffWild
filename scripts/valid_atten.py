...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_gru_atten_15/output_valid.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face_gru_atten_15/'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face_gru_atten_15/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
...
def evaluate():
    ...
    with g.as_default():
        ...
        prediction = models.get_prediction_atten(rnn_in, attn_length=15)
