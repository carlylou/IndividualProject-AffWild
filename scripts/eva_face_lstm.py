...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face-lstm-128/output_valid.txt')
...
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face-lstm-128/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
