...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/dense121_atten_case2_e5/output_train.txt')
...
TRAIN_DIR = '/vol/gpudata/ml9915/check_point/dense121_atten_case2_e5/'
