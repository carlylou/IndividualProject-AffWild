...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_atten_case3_70/output_train.txt')
...
TRAIN_DIR = '/vol/gpudata/ml9915/check_point/face_atten_case3_70/'
...
RNN_RESTORE_PATH = '/vol/gpudata/ml9915/check_point/face_atten_case2_70/model.ckpt-46294'

# HYPER-PARAMETERS
BATCH_SIZE = 2
# try 80, 100, if 100 is better, try 200. or try 70
SEQUENCE_LENGTH = 70
...
def train():
    ...
    with g.as_default():
        ...
        with tf.Session(graph=g) as sess:
            ...
            VGGFace_network.setup(image_batch, trainable=True)
            ...
            resnet_init_assign_op, resnet_init_feed_dict = slim.assign_from_checkpoint(
                VGG_RESTORE_PATH, get_CNN_variables(), ignore_missing_vars=False)
