...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_indRNN_simple/output_valid.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face_indRNN_simple/'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face_indRNN_simple/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
