...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/dense121_atten_case3/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/dense121_atten_case3/'
GLOBAL_STEP = 97695
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-' + str(GLOBAL_STEP)
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/dense121_atten_case3/test/'
