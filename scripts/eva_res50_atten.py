...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/res50_atten/output_valid.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/res50_atten/'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/res50_atten/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
