...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_indRNN/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face_indRNN/'
GLOBAL_STEP = 29293
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-' + str(GLOBAL_STEP)
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face_indRNN/test/'
