...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/gru-mean/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/gru-mean/'
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-41920'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/gru-mean/test/'
OUTPUT_FILE = '/vol/gpudata/ml9915/summary/gru-mean/test/output_test.txt'
# HYPER-PARAMETERS
FRAMES_VALID = 135145
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
...
def evaluate():
    ...
    with g.as_default():
        ...
        for i, name in enumerate(['valence', 'arousal']):
            ...
            write('eval/concordance_' + name + ' ' + str(concordance_cc2))
            ...
            write(mse_eval + ' ' + str(names_to_values[mse_eval]))
