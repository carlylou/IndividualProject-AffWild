...
'''
This is VGGFACE trained with fix CNN and train RNN and last conv layer.
...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face_atten_case1/output_train.txt')
...
TRAIN_DIR = '/vol/gpudata/ml9915/check_point/face_atten_case1/'
...
def get_variables_to_train():
    trainable_names = ['conv_13', 'attention-layer', 'fcatten']
    variables_to_train = []
