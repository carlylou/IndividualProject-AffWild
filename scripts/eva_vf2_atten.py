...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/face2_gru_atten_trainCNN/output_valid.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/face2_gru_atten_trainCNN/'
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/face2_gru_atten_trainCNN/'
# HYPER-PARAMETERS
FRAMES_VALID = 94223
SEQUENCE_LENGTH = 80
BATCH_SIZE = 1
