...
fh = logging.FileHandler('/vol/gpudata/ml9915/summary/dense169_atten/test/output_test.txt')
...
CHECK_POINT_DIR = '/vol/gpudata/ml9915/check_point/dense169_atten/'
GLOBAL_STEP =75206
MODEL_PATH = CHECK_POINT_DIR + 'model.ckpt-' + str(GLOBAL_STEP)
SUMMARY_PATH = '/vol/gpudata/ml9915/summary/dense169_atten/test/'
