...
def load_image(addr):
    # read an image and resize to (96, 96)
...
videoPath = '/vol/bitbucket/ml9915/test/testVideos/'
annotationPath = '/vol/bitbucket/ml9915/test/testLabel/'
tfRecordsPath = '/vol/bitbucket/ml9915/TFRecords/test/'
